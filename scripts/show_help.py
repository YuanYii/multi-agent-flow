...
HELP_MANUAL = {
    ...
    "experts": [
        ...
        {"role": "ARCHITECT", "name": "钱架构", "title": "系统架构师", "duties": "系统总体架构设计、ADR 决策记录、模块边界划分与架构重构治理"},
        {"role": "DEV", "name": "李开发", "title": "开发工程师", "duties": "后端/全栈业务编码、单元测试覆盖（≥80%）、代码重构与 Git 历史保护"},
        {"role": "FRONTEND", "name": "马前端", "title": "前端开发工程师", "duties": "现代 Web/UI 组件与交互开发、前端体验优化与组件迁移治理"},
        {"role": "REVIEWER", "name": "周审查", "title": "代码审查专家", "duties": "代码规范审查、安全漏洞扫描、越权风险审计与 Git 历史连续性核验"},
        {"role": "QA", "name": "章测试", "title": "测试工程师", "duties": "端到端集成测试、边界与极限场景覆盖、缺陷复现与质量准出"},
        {"role": "DOCS", "name": "李文通", "title": "文档工程师", "duties": "工程文档架构治理、操作手册、API 文档维护与文档迁移归档"},
...
def format_text_output() -> str:
    ...
    lines.append("5. Git 历史延续性: 文件重命名、移动或重构严禁删除重建，必须使用 git mv 保持提交历史。")
    lines.append("=" * 80)
    return "\n".join(lines)
