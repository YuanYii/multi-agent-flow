...
| 场景 | 示例 Prompt | 结果 |
| :--- | :--- | :--- |
| **L0 即时问答** | “解释一下项目架构设计” / “查找接口规范” | 分级三问判定为 L0 → 直接作答，免建卡且不调用 CLI |
| **L1 轻量任务** | “更新部署说明文档” / “调整运维配置” | 走短链（B/C/D/F/G）：【待开始】→【进行中】→【已完成】→ PM【已验收】 |
...
- **任务分级系统 (L0/L1/L2)**：PM 派单时执行“分级三问”，L0 即时问答无卡直答（免建卡且不变量豁免，草稿入 `草稿箱/` 隔离），L1 轻量任务短链直达验收（B/C/D/F/G 免审查/测试），L2 核心开发走标准全链；明确 L0 无卡不违规且不触发孤儿产出告警。
