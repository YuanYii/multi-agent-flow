...
def test_no_undefined_global_function_calls():
    ...
    helpers = ["esc", "badgeInner", "getBadgeStyle", "showToast", "applyFilters", "renderTable", "openTaskDetail", "closeDetailModal", "toggleTaskEditMode", "saveTaskDetails", "refreshUiSelects"]
